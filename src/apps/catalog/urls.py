...
urlpatterns = [
    ...
    path("products/import/", views.ProductImportUploadView.as_view(), name="product_import_upload"),
    path("products/import/mapowanie/", views.ProductImportMappingView.as_view(), name="product_import_mapping"),
