...
urlpatterns = [
    ...
    path("lokalizacje/importuj/", views.LocationImportUploadView.as_view(), name="location_import_upload"),
    path("lokalizacje/importuj/mapowanie/", views.LocationImportMappingView.as_view(), name="location_import_mapping"),
